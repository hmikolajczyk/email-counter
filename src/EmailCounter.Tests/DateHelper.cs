...
{
    [Fact]
    public void CalculatePreviousMonthRange_ShouldReturnCorrectDateRange()
    {
        ...
        var (actualStart, actualEnd) = DateHelper.CalculatePreviousMonthRange(inputDate);
    ...
    [Fact]
    public void CalculatePreviousMonthRange_YearTransitioning_ShouldReturnDecemberRange()
    {
    ...
    [Fact]
    public void CalculatePreviousMonthRange_NonLeapYear_ShouldReturnCorrectFebruaryRange()
    {
    ...
    [Fact]
    public void CalculatePreviousMonthRange_LeapYear_ShouldReturnCorrectFebruaryRange()
    {
